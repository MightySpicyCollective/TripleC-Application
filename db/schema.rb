...
ActiveRecord::Schema.define(version: 20160902155110) do
  ...
  add_index "comments", ["project_id", "created_at"], name: "index_comments_on_project_id_and_created_at", using: :btree
